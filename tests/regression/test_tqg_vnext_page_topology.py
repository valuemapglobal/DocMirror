...
_CASES = load_track_manifest(TQG_GATES_DIR / "vnext_page_topology.yaml")


@pytest.mark.track_vnext_page_topology
@pytest.mark.parametrize("case", _CASES, ids=lambda c: c.id)
def test_tqg_vnext_page_topology_case(case, tqg_report_dir):
