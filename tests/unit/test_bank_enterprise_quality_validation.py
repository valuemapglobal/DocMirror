...
def test_run_validation_balance_chain_passes():
    records = [
        {"date": "2024-01-01", "timestamp": "2024-01-01", "amount": 100.0, "direction": "income", "balance": 100.0, "summary": "a"},
        {"date": "2024-01-02", "timestamp": "2024-01-02", "amount": 50.0, "direction": "expense", "balance": 50.0, "summary": "b"},
    ]
...
def test_compute_quality_short_statement_uses_geo_mean_only():
    records = [
        {"row_index": 1, "normalized": {"date": "2024-01-01", "timestamp": "2024-01-01", "amount": 1.0, "summary": "x", "direction": "income"}},
    ]
