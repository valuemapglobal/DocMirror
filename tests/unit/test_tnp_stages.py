...
def test_tnp_stage_modules_expose_symbols():
    from docmirror.tables.pipeline import stage_domain, stage_header, stage_preamble, stage_structure
...
def test_tnp_hooks_package():
    from docmirror.tables.pipeline.hooks import run_generic_hook, run_ledger_borderless_hook
