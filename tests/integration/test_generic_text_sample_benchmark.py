...
EXPECTED_FIELDS = {
    ...
    "household_registration": {
        ...
        "与户主关系": "本人",
        "户口登记机关": "某某派出所",
        "登记日期": {"value": "2010-01-01"},
    },
    "loan_contract": {
        "合同编号": "LN20260101001",
        "借款人": "吴九",
        "贷款金额": {"value": 500000.0, "currency": "CNY"},
        "贷款期限": "36个月",
    },
    "drivers_license": {
        "驾驶证号": "420106198801011234",
        "准驾车型": "C1",
        "初领日期": {"value": "2010-05-01"},
    ...
    "mortgage_contract": {
        "抵押权人": "某某银行股份有限公司",
        "抵押人": "郑十",
        "被担保债权数额": {"value": 800000.0, "currency": "CNY"},
    ...
    "fiscal_invoice": {
        "票据代码": "310001",
        "票据号码": "0001234567",
        "开票日期": {"value": "2026-01-01"},
        "收款单位": "某某财政局",
    },
    "payroll_slip": {
        "员工姓名": "钱十一",
        "实发工资": {"value": 15000.0, "currency": "CNY"},
    },
    "passport": {
        "护照号码": "E12345678",
        "姓名": "李四",
