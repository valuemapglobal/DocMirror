...
"""
OCR runner — multi-scale recognition and fragment merging.
...
Upstream: ``ocr.preprocess.pipeline`` prepared images.
...
from docmirror.ocr.reconstruct.grid import _probe_best_orientation
