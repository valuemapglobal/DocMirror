...
def _np() -> Any:
    return require_optional_module("numpy", feature="RapidOCR scanned OCR", extra="ocr")
...
class RapidOCREngine:
    ...
    def __init__(self):
        ...
        if self._engine is None:
            RapidOCR = require_optional_module(
                "rapidocr_onnxruntime",
                feature="RapidOCR scanned OCR",
                extra="ocr",
            ).RapidOCR
    ...
    def _nms_boxes(self, boxes: list[Any], iou_threshold: float = 0.5) -> list[Any]:
        """
