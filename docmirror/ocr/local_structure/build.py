...
from docmirror.ocr.local_structure.models import (
    BBox,
    LocalStructure,
...
from docmirror.ocr.local_structure.utils import line_items, union_bbox
...
def _prefers_field_grid(
    ...
    *,
    ...
    from docmirror.ocr.field_grid.bands import segment_field_sections
...
def build_local_structures(
    ...
    *,
    ...
    from docmirror.ocr.field_grid.bands import align_col_bands_across_structures
    from docmirror.ocr.field_grid.build import build_field_grid_from_block
    from docmirror.ocr.local_structure.utils import coerce_tokens
