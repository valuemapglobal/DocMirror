...
from docmirror.ocr.page_canvas.block_index import build_page_blocks, pcm_blocks_enabled, pcm_mo_enabled
from docmirror.ocr.page_canvas.build import build_regions_from_domain_specific
from docmirror.ocr.page_canvas.flow_filter import filter_flow_texts_not_in_regions
from docmirror.ocr.page_canvas.models import PageCanvas, PageFlow, PageRegion
from docmirror.ocr.page_canvas.morphology_orchestrator import (
    ...
    *,
    ...
    if pcm_blocks_enabled():
        if pcm_mo_enabled():
            ...
            from docmirror.ocr.page_canvas.block_index import reading_order_v1_from_blocks
