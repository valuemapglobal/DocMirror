...
from docmirror.ocr.page_canvas.models import PageRegion
...
def _apply_detect_audit_for_page(
    ...
    *,
    ...
    if not domain_specific:
        from docmirror.ocr.page_canvas.detect import annotate_region_nested_in_audit
    ...
    if lines:
        ...
        from docmirror.ocr.page_canvas.detect import (
