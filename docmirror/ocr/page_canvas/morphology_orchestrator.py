...
from docmirror.ocr.page_canvas.block_index import pcm_mo_enabled
from docmirror.ocr.page_canvas.models import PageBlock, PageFlow, PageRegion
...
def orchestrate_page_morphology(
    ...
    *,
    ...
    from docmirror.ocr.page_canvas.block_index import (
        build_page_blocks,
