...
def _apply_detect_audit_for_page(
    ...
    *,
    ...
    if not domain_specific:
        from docmirror.topology.page_projection.detect import annotate_region_nested_in_audit
    ...
    if lines:
        ...
        from docmirror.topology.page_projection.detect import (
...
def build_regions_from_domain_specific(
    ...
    *,
    ...
    from docmirror.models.mirror.page_evidence_bundles import micro_grid_structures_from_bundles
...
def reading_order_for_page(
    ...
    Exporters should prefer block-index reading order when blocks are available.
    """
    if not flow_texts:
...
def reading_order_v2(
    ...
    *,
    ...
    return reading_order, reading_order_refs_from_blocks(blocks)
