...
from docmirror.sdk.integration.request import ParseRequest, InputRef
...
from docmirror.sdk.integration.artifacts import ArtifactManifest, load_artifact_manifest
...
async def orchestrate_parse(request: ParseRequest, output_dir: str | Path = "output") -> dict[str, Any]:
    ...
    try:
        ...
        manifest = result.to_mirror_json_vnext() if hasattr(result, "to_mirror_json_vnext") else {}
