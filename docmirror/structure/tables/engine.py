...
def _extract_tables_layered_registry(
    ...
    """
    from docmirror.structure.tables.method_reconstructor import TableMethodContext, TableMethodRegistry
    ...
    from docmirror.structure.tables.structure_detect import detect_pipe_grid_page, page_has_no_drawing_primitives
    ...
    if not skip_l2:
        ...
        if usable:
            ...
            try:
                from docmirror.structure.tables.utils import _refine_dense_rows
...
def extract_tables_layered(
    ...
    if not _skip_l2:
        ...
        if candidates:
            ...
            try:
                from docmirror.structure.tables.utils import _refine_dense_rows as _rdfn
...
from docmirror.structure.tables.layers.backends import (
