...
from docmirror.structure.tables.char.vocab_boundary import _adjust_boundaries_by_vocab
from docmirror.structure.tables.utils import _adaptive_row_tolerance
