...
from docmirror.structure.ocr.preprocess.legacy_fallback import _render_page_to_bgr
from docmirror.structure.ocr.recognize.runner_legacy import _run_ocr
from docmirror.structure.ocr.reconstruct.grid_legacy import _detect_table_lines_hough
from docmirror.structure.ocr.scanned.analyze_page import analyze_scanned_page
from docmirror.structure.ocr.micro_grid.models import OCRToken, TieredTokenCollection
            ...
            if out is not None:
                if isinstance(out, dict) and out.get("content_type") in ("table", "general"):
                    if out.get("content_type") == "table":
                        from docmirror.structure.ocr.ocr_postprocess import postprocess_ocr_result
