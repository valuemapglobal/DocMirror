...
Implementation lives in ``docmirror.structure.ocr.field_grid``; this module re-exports
...
from docmirror.structure.ocr.micro_grid.models import MicroGridCell, OCRToken
