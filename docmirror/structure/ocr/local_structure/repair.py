...
from docmirror.structure.ocr.local_structure.models import BBox
from docmirror.structure.ocr.micro_grid.cell_recognition import pdf_bbox_to_image_region
