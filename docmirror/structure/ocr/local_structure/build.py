...
from docmirror.structure.ocr.local_structure.utils import line_items, union_bbox
...
def _prefers_field_grid(
    ...
    *,
    ...
    from docmirror.structure.ocr.field_grid.bands import segment_field_sections
...
def build_local_structures(
    ...
    *,
    ...
    from docmirror.structure.ocr.field_grid.bands import align_col_bands_across_structures
    from docmirror.structure.ocr.field_grid.build import build_field_grid_from_block
    from docmirror.structure.ocr.local_structure.utils import coerce_tokens

    items = line_items(lines, page=page)
    token_list = coerce_tokens(tokens, page=page)
    from docmirror.structure.ocr.local_structure.candidate_supplement import supplement_local_structure_candidates
    from docmirror.structure.ocr.local_structure.detect import detect_local_structure_candidates
    from docmirror.structure.ocr.page_canvas.page_segment import grid_anchor_top_from_lines, is_lattice_content_line
...
def _attach_region_crop_ocr(
    ...
    *,
    ...
    from docmirror.structure.ocr.local_structure.repair import recognize_structure_region_from_image
