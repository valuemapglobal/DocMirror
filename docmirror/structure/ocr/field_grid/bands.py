...
from docmirror.structure.ocr.field_grid.models import LabelToken
...
def union_cell_bbox(boxes: list[BBox]) -> BBox:
 ...
 #   from docmirror.structure.ocr.field_grid.bands import enrich_col_bands_with_context
from docmirror.structure.ocr.ocr_postprocess import enrich_col_bands_with_context  # noqa: F401
