...
from docmirror.structure.evidence_plane import EvidencePage, EvidencePlane
    ...
    def _segment_page_block_regions(
        ...
        *,
        ...
        if len(line_groups) < 3:
            return []
        try:
            from docmirror.structure.ocr.page_canvas.page_segment import segment_page_blocks
        except Exception:
            return []
...
def _table_grid_from_tokens(
    ...
    *,
    ...
    if len(block_tokens) < 6:
        return []
    try:
        from docmirror.structure.ocr.reconstruct.grid_legacy import reconstruct_table_grid_from_tokens
    except Exception:
        return []
    try:
