...
from docmirror.structure.tables.structure_detect import PipeGridSignal, detect_pipe_grid_in_text
...
def apply_page_morphology_spe(
    ...
    *,
    ...
    from docmirror.structure.ocr.page_canvas.block_index import document_morphology_stats
