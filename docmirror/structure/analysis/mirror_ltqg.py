...
from docmirror.structure.analysis.spe_consumer import mirror_expected_primary_rows, read_ltqg_summary
...
def attach_mirror_ltqg(parse_result: Any, base_metadata: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    if summary.get("enabled"):
        ...
        legacy = int(structure.get("ltqg_legacy_max_rows") or 0) if structure else 0
        if legacy:
            ds["mirror_ltqg_legacy_max_rows"] = legacy
