...
"""Physical adapter blocks → canonical ParseResult page mapping."""
...
def assemble_pages(page_layouts: list[Any] | tuple[Any, ...], metadata: dict[str, Any] | None = None):
    """Convert physical pages/blocks into canonical ``PageContent`` values.
    ...
    page_layouts = list(page_layouts)
    meta = metadata or {}
