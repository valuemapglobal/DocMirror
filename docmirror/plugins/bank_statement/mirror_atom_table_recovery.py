...
"""Recover high-confidence split debit/credit ledgers from Mirror text atoms."""
...
def recover_mirror_atom_bank_tables(parse_result: Any) -> list[list[list[str]]]:
...
__all__ = ["recover_mirror_atom_bank_tables"]
