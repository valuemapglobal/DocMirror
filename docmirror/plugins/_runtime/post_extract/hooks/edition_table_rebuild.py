...
canonical physical tables are preserved.

Key exports: ``EditionTableRebuildHook``.
"""
...
class EditionTableRebuildHook(PostExtractHook):
    hook_id = "edition_table_rebuild"
    ...
    def apply(
        ...
        *,
        ...
        enrichment["bank_table_rebuild"] = {
            ...
            "status": "edition_only",
            "note": "Canonical ParseResult tables preserved; rebuild remains edition-only",
        }
        logger.info(
