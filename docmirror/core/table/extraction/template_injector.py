...
def build_global_template(page_plum, extracted_table: List[List[str]]) -> Optional[GlobalTableTemplate]:
    """
    ...
    all_x0 = [c["x0"] for c in text_chars]
...
def extract_by_injected_template(page_plum, template: GlobalTableTemplate) -> Optional[List[List[str]]]:
    """
