...
from docmirror.core.analyze.sso_config import pipe_grid_veto_threshold, scene_hint_prior_delta
from docmirror.core.table.structure_detect import detect_pipe_grid_in_text
