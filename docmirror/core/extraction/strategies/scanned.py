...
"""
Scanned extraction strategy — thin wrapper to generic CPS + OCR path (Phase 4).
"""
...
@register_strategy("scanned")
class ScannedStrategy(BaseExtractionStrategy):
    """Thin registry entry for scan-led documents."""
