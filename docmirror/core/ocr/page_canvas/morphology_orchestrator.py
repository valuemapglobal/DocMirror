...
from docmirror.core.ocr.page_canvas.block_index import pcm_mo_enabled
from docmirror.core.ocr.page_canvas.models import PageBlock, PageFlow, PageRegion
...
def orchestrate_page_morphology(
    ...
    *,
    ...
    from docmirror.core.ocr.structure_project import assign_schema_hints_to_regions
