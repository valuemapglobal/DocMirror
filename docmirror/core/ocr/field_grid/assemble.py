...
from docmirror.core.ocr.field_grid.bands import union_cell_bbox
from docmirror.core.ocr.field_grid.models import FieldCell
from docmirror.core.ocr.field_grid.type_gate import apply_type_gate, infer_types
...
def parse_as_of_date(text: str) -> str | None:
    """Extract dotted date from a 截至YYYY年MM月DD日 status header line."""
