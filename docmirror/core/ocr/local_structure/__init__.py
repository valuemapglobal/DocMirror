...
from docmirror.core.ocr.local_structure.build import build_local_structures, extract_local_structure_evidence
...
from docmirror.core.ocr.local_structure.repair import RegionRecognition, recognize_structure_region_from_image
