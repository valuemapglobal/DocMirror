...
SHRINK_ONLY_BASELINE: dict[str, int] = {
    ...
    "docmirror.input.extraction.scanned_table_reconstructor": 1129,
    "docmirror.models.entities.parse_result": 1063,
    "docmirror.models.mirror.core": 1037,
    "docmirror.output.community_bundle": 1070,
    "docmirror.plugins._base.generic_community_adapter": 2590,
