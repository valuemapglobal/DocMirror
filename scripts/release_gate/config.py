...
STEPS: tuple[GateStepDef, ...] = (
    ...
    GateStepDef(
        "validate_ga_6plus1_manifest",
        "P1 mandatory 6+1 GA manifest policy",
        "contracts",
        "shell",
        frozenset({"standard", "full"}),
        ("python3", "scripts/validate/validate_ga_6plus1.py", "--manifest-only"),
    ),
    GateStepDef(
        "validate_performance_baseline_manifest",
        "P1 long-document performance baseline manifest",
        "contracts",
        "shell",
        frozenset({"standard", "full"}),
        ("python3", "scripts/validate/validate_performance_baseline.py", "--manifest-only"),
    ),
    GateStepDef(
    ...
    GateStepDef(
        "validate_p0_architecture",
        "P0 canonical fact pipeline",
        "architecture",
        "shell",
        frozenset({"standard", "full"}),
        ("python3", "scripts/validate/validate_p0_architecture.py"),
    ),
    GateStepDef(
        "validate_p1_architecture",
        "P1 core stability architecture convergence",
        "architecture",
        "shell",
        frozenset({"standard", "full"}),
        ("python3", "scripts/validate/validate_p1_architecture.py"),
    ),
    GateStepDef(
        "validate_p2_architecture",
        "P2 plugin-owned business resources",
        "architecture",
        "shell",
        frozenset({"standard", "full"}),
        ("python3", "scripts/validate/validate_p2_architecture.py"),
    ),
    GateStepDef(
        "validate_core_contract_freeze",
        "P1 semantic core contract freeze",
        "architecture",
        "shell",
        frozenset({"standard", "full"}),
        ("python3", "scripts/validate/validate_core_contract_freeze.py"),
    ),
    GateStepDef(
        "validate_p1_stability_readiness",
        "P1 aggregate stability evidence manifest",
        "architecture",
        "shell",
        frozenset({"standard", "full"}),
        ("python3", "scripts/validate/validate_p1_stability_readiness.py", "--manifest-only"),
    ),
    GateStepDef(
